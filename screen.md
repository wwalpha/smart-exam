...
| 復習テスト一覧               | `/exam/questions`             | review/ExamQuestionListPage.tsx      |
| 復習テスト作成               | `/exam/questions/new`         | review/ExamQuestionCreatePage.tsx    |
| 復習テスト詳細               | `/exam/questions/:id`         | review/ExamQuestionDetailPage.tsx    |
| 復習テスト採点               | `/exam/questions/:id/grading` | review/ExamQuestionGradingPage.tsx   |
| 復習テストPDF                | `/exam/questions/:id/pdf`     | review/ExamQuestionPdfPage.tsx       |
| 漢字テスト一覧               | `/exam/kanji`                 | review/ExamKanjiListPage.tsx         |
| 漢字テスト作成               | `/exam/kanji/new`             | review/ExamKanjiCreatePage.tsx       |
| 漢字テスト詳細               | `/exam/kanji/:id`             | review/ExamKanjiDetailPage.tsx       |
| 漢字テスト採点               | `/exam/kanji/:id/grading`     | review/ExamKanjiGradingPage.tsx      |
| 漢字テストPDF                | `/exam/kanji/:id/pdf`         | review/ExamKanjiPdfPage.tsx          |
