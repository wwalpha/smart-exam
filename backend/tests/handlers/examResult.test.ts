...
describe('examResult handler', () => {
  it('listExamResults returns results', async () => {
    ...
    vi.mocked(ExamResultsRepository.listExamResults).mockResolvedValue(mockResults as any);
  ...
  it('createExamResult creates result', async () => {
    ...
    vi.mocked(ExamResultsRepository.createExamResult).mockResolvedValue(mockResult as any);
